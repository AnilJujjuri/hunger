  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
       ...
       <a href="addToCart"><button class="button" style="vertical-align:middle" id="1" ><!-- onclick="confirmBox()" --><span>Add to cart </span></button></a>
...
<footer class="container-fluid text-center">
  <p>Designed and Developed by Anil Jujjuri</p>  
